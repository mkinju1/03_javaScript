...
function check13(){
  ...
  for(let num = 1 ; num <= 20 ; num++){   // 1~20 까지 1씩 증가하는 반복문
...
function check16(){
  ...
  for(let row = 0 ; row < 3 ; row++){ //012 3회 반복
