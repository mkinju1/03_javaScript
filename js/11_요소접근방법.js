...
function nameTest(){
  ...
  */
  ...
  // 요소가 1개 밖에 없음 ( 이 경우엔 name-div가 1개여서) == 0번 인덱스만 존재
...
function cssTest1(){
  ...
  // target-div 속성값이 css-div인 요소 하나 선택
  ...
  // target-div 속성값이 css-div인 요소의 자식 중 div 요소를 모두 선택해 얻어옴
  const divs
