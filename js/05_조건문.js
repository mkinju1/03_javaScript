...
function check1(){
  ...
  // input1.value : input1 요소에 입력된 값 (string 형태)
...
function check5(){
  ...
  // 1) A와 B 중 하나라도 입력되지 않으면
  //    --> 입력되지않은 값이 존재합니다
  
  if(a.value.length === 0 || b.value.length === 0){
    alert("입력되지않은 값이 존재합니다")
    return; // Eatly return : 함수를 여기서 일찍 끝냄
  }
...
// 매개 변수(parameter)
// 함수 호출 시 전달된 값(전달인자, arguments)을
// 저장하는 변수
