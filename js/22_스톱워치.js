...
// const는 상수 let은 변수
// 0번 index : 분 / 1번 index : 초 / 2번 index : 1/100초
...
/* START 버튼 클릭 시 
  ...
  startBtn.addEventListener("click", () => {
    ...
    // START 버튼 클릭 시 버튼의 내용을 PAUSE로 변경하겠다
    startBtn.innerText = "PAUSE";

    // RECORD 버튼의 비활성화를 활성화로 변경
...
recordBtn.addEventListener("click", ()=>{
  ...
  /*   
    // innerHTML : HTML 문서 내용 그대로 주석까지 얻어옴
    console.log( display. innerHTML ); 

    // innerText : 태그, 주석 무시하고 작성된 Text(내용)만 얻어옴
    console.log( display. innerText ); 

    // textContent : Text를 얻어오는데 공백 문자도 포함해서 얻어옴
