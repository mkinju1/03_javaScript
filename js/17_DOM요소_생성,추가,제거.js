  ...
  btns[i].addEventListener("click", () => {
    ...
    switch(str){
      ...
      case "append": 
        ...
        standard.append(span2); // #standard 마지막 자식으로 span1 추가
      ...
      case "before": 
        ...
        div1.className = "box"; // box 클래스를 추가
      ...
      case "after": 
        ...
        div2.innerText = count; // 내용으로 count 추가
        div2.style.backgroundColor = "orange"; // 배경색 추가
        div2.className = "box"; // box 클래스를 추가
